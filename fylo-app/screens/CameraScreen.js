...
const CameraScreen = ({ user, sessions, visible, handleClose }) => {
                                ...
                                {!image ? (
                                    <>
                                        <View style={{flex: 1, justifyContent: "flex-start"}} >
                                            <Pressable onPress={() => {setAspectRatio('3/4'); setVideoMode(false)}} style={[{height: "50%", margin: 5, justifyContent: "center", alignItems: "center", borderRadius: 20}, !videoMode && {backgroundColor: "#E8763A"}]}>
                                                <Button icon='image' size={30} color='white' onPress={() => {setAspectRatio('3/4'); setVideoMode(false)}} />
                                            </Pressable>
                                        </View>
                                        <View style={{flex: 1, justifyContent: "flex-start"}} >
                                            <Pressable onPress={() => {setAspectRatio('9/16'); setVideoMode(true)}} style={[{height: "50%", margin: 5, justifyContent: "center", alignItems: "center", borderRadius: 20}, videoMode && {backgroundColor: "#E8763A"}]}>
                                    ...
                                    <>
                                        <Pressable style={{flex: 1, justifyContent: "flex-start"}} onPress={() => setImage(null)}>
                                            <View style={{height: "50%", backgroundColor: "#E8763A", margin: 5, justifyContent: "center", alignItems: "center", borderRadius: 20}}>
